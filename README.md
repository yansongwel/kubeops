...
KubeOps 采用**微服务架构**，部署在 Kubernetes 上：
...
| 服务 | 描述 | 技术栈 |
|---------|-------------|------------|
| **API 网关** | 流量入口、认证、限流、路由 | APISIX / Higress |
| **服务网格** | 流量管理、安全、可观测性 | Istio |
| **Kube 管理器** | K8s 资源管理 | Go + controller-runtime |
| **AI 巡检** | AI 智能分析 | Go + OpenAI/Ollama |
| **DevOps 服务** | Jenkins + ArgoCD 集成 | Go + gRPC |
| **日志服务** | 日志聚合 (ELK/Loki) | Go + Vector |
| **监控服务** | 指标和告警 | Go + Prometheus |
